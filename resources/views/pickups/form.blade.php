@php /** @var \App\Models\Pickup $pickup */
        ...
        <div class="form-row">
            ...
            <div class="form-group col-sm-12">
                ...
                <div class="guest-inputs form-row form-inline">
                            ...
                            <select name="guest_address_id" id="guest_clientAddress" class="form-control selectpicker" required
                                ...
                                @foreach($addresses as $address)
                                    <option value="{{ $address->id }}" data-subtext="{{ $address->zone->name }}"
                                            {{ old('shipment_client.address_id') == $address->id || (isset($pickup) && $is_guest && !is_null($pickup->guest) &&
                    ...
                    <div class="form-group col-6" {!! $is_guest ?: 'style="display:none;"' !!}>
                        <label for="guest_clientAddressDetailed" class="mr-2">@lang('pickup.address_text')</label>
