...
@section('content')
    <nav class="nav inner-nav">
        <a href="{{ route('settings.index', ['tab'=>'company']) }}"
           class="{{ $tab != "company" ?: "active" }}"><i class="fa-info-circle"></i>
            @lang('settings.company.label')
        </a>
        <a href="{{ route('settings.index', ['tab'=>'accounting']) }}"
           class="{{ $tab != "accounting" ?: "active" }}"><i class="fa-info-circle"></i>
            @lang('settings.accounting.label')
        </a>
        <a href="{{ route('settings.index', ['tab'=>'branches']) }}"
           class="{{ $tab != "branches" ?: "active" }}"><i class="fa-info-circle"></i>
            @lang('branch.label')
        </a>
    </nav>
