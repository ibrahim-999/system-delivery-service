    ...
    <div class="d-flex">
        <div class="mt-4 mx-auto">
            <p class="alert alert-info">
                @lang('settings.company.note')</p>
            <div class="form-group form-row">
                <label for="company.name"
                       class="col-form-label col-md-4">
                    @lang('settings.company.name')</label>
                <div class="col-md-8">
                    <input type="text" class="form-control" name="company.name" id="company.name"
                           value="{{ Setting::get("company.name") }}"
                           placeholder="
                           @lang('settings.company.name')">
                </div>
            </div>
            <div class="form-group form-row">
                <label for="company.address"
                       class="col-form-label col-md-4">
                    @lang('settings.company.address')</label>
                <div class="col-md-8">
                <textarea name="company.address" id="company.address" placeholder="
                @lang('settings.company.address')"
