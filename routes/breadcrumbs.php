...
Breadcrumbs::for('couriers.show', function ($trail, Courier $courier) {
    $trail->parent('couriers');
    $trail->push($courier->name, route('couriers.show', [$courier]));
});

Breadcrumbs::for('couriers.edit', function ($trail, Courier $courier) {
    $trail->parent('couriers');
...
Breadcrumbs::for('accounting.invoice', function ($trail, Invoice $invoice) {
    $trail->parent('home');
